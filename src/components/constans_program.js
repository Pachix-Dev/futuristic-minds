    ...
    oct_4: [
      {
        ...
        hour: '09:00 hrs',
        duration: '45 min',
        name: 'Oscar Mora Cantoral',
        avatar: '',
        avatar2: '',
        logo: '/futuristic-minds/img/slider/osmotronik.webp',
        rol:'Director y Fundador de la Academia de Robótica',
        form: '',
        institution: 'Osmotronik',
        conference: 'Humanoides 2S WhalesBot',
        resume: 'Los asistentes podrán aprender a programar servomotores por ángulos y fuerza, también podrán controlar las extremidades del robot mediante un control en tiempo real.'
      },
      {
        id: 0,
        id_s2: 0,
    ...
    oct_5: [
      {
        id: 0,
        id_s2: 0,
        hour: '09:00  -  15:00 hrs',
        duration: '6 hrs',
        name: 'Final de la Competencia M-Tech 2023',
        avatar: '',
        avatar2: '',
        logo: '/futuristic-minds/img/slider/m-tech.webp',
        rol:'',
        form: '',
        institution: 'Italian Exhibition Group | Deutsche Messe',
        conference: '',
        resume: ''
      },
    ],
