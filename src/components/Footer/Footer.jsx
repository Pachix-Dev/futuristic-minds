      ...
      <>
          <div className='container-footer'>
              <Navbar expand='lg' className='menu py-4 d-flex justify-content-evenly'>
                  <a href='https://hfmexico.mx' target='_blank' rel='noopener noreferrer'><img className='mx-3 img-fluid company-logo' src={logoIGECO} alt='igeco-mexico-logo' width="180" /></a>
                  <a href='https://hfmexico.mx' target='_blank' rel='noopener noreferrer'><img className='mx-3 img-fluid company-logo' src={deutsche} alt='deutsche-messe-logo' width="180" /></a>
                  <a href='http://www.explora.edu.mx/' target='_blank' rel='noopener noreferrer'><img className='mx-3 img-fluid company-logo' src={explora} alt='explora-logo' width="180" /></a>
                  <a href='https://www.guanajuato.gob.mx/' target='_blank' rel='noopener noreferrer' className='ml-auto'><img className='mx-3 img-fluid company-logo' src={gto} alt='gobierno-guanajuato-logo' width="180" /></a>
              </Navbar>
              <Container>
                          ...
                          <Card border="info" className='body-card' style={{ width: 'auto', height: 'auto' }}>
                              ...
                              <Card.Body>
                                  ...
                                  <Card.Text>
                                      ...
                                      <p><a href='mailto:daniela.hernandez@igeco.mx' className='link link-correo text-center'>daniela.hernandez@igeco.mx</a></p>
